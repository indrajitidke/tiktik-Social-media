...
const Sidebar = () => {
    ...
    const normalLink ='flex item-center gap-3 hover:bg-primary p-3 justify-center xl:justify-start cursor-pointer font-semibold rounded';
                ...
                {/* {!userProfile && (
                    <div className='px-2 py-4 hidden xl:block'>
                        ...
                        <div className='pr-4'>
                            ...
                            onSuccess={()=>{}} onFailure={()=>{}}  cookiePolicy='single-host-origin'/> 
