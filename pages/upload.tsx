        ...
        <div className='bg-white rounded-lg xl:h=[80vh] w-[60%] flex gap-6 flex-wrap justify-between items-center p-14 pt-6' >
            <div>
                                ...
                                videoAsset?(
                                    ...
                                    <label className='cursor-pointer'>
                                        <div className='flex flex-col items-center justify-center h-full' >
                                            ...
                                            <p className='text-bold text-xl' ><FaCloudUploadAlt className='text-gray-300 text-6xl' /></p>
                                        ...
                                        <p className='bg-[#F51997] text-center mt-10 rounded text-white text-md font-medium p-2 w-52 outline-none'> Select File
                ...
                <div className='flex flex-col gap-3 pb-10'>
                    ...
                    <input className='rounded outline-none text-md border-2 border-gray-200 p-2' type="text" value={caption} onChange={(e)=>setCaption(e.target.value)} />
                    ...
                    <select className="outline-none border-2 border-gray-200 text-md capitalize lg:p-4 p-2 rounded cursor-pointer"  onChange={(e)=>setCategory(e.target.value)} >
                        {topics.map((topic)=>(
                            <option key={topic.name} value={topic.name}  className='outline-none capitalize bg-white text-gray-700 text-md p-2 hover:bg-slate-300'>
                                {topic.name}
                            </option>
                        ))}
                    </select>
